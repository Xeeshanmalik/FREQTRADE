...
# --min-score 40: chosen over the higher-PF 45 to roughly double trade frequency
# (~0.6 vs ~0.3/week) so the dry-run shows activity sooner; still profitable in
# backtest (+14.7% / PF ~1.76). See gap_score_threshold in the strategy.
