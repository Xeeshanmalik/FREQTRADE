...
# --min-score 40: looser than the 45 default; ~2x trade frequency at a thinner
# per-trade edge (PF 1.76 vs 2.14, +14.7% vs +8.9% over 2025-06-20..2026-06-04).
# See gap_score_threshold in the strategy.
